...
const ImageCarousel = lazy(() => import('./components/sections/ImageCarousel').then(module => ({ default: module.ImageCarousel })));
const LocationAdvantage = lazy(() => import('./components/sections/LocationAdvantage').then(module => ({ default: module.LocationAdvantage })));
const ConfigurationCards = lazy(() => import('./components/ConfigurationCards').then(module => ({ default: module.ConfigurationCards })));
const Amenities = lazy(() => import('./components/sections/Amenities').then(module => ({ default: module.Amenities })));
const ProjectHighlights = lazy(() => import('./components/sections/ProjectHighlights').then(module => ({ default: module.ProjectHighlights })));
